...
import { acceptTerms, userSelector } from '../state';
...
class AcceptPrivacyTerms extends Component {
  ...
  render() {
    ...
    return (
      <Fragment>
        <Helmet>
          <title>Privacy Policy and Terms of Service | codetribe.com</title>
        </Helmet>
        <Spacer size={2} />
        ...
        {/*        >*/}
        {/*          I want weekly emails from Quincy, codetribe.com's founder.*/}
        {/*        </Checkbox>*/}
        {/*      </FormGroup>*/}
        {/*      <ButtonSpacer />*/}
        {/*      <Button*/}
