  ...
  render() {
    ...
    return (
      <>
        ...
        <div
          className={`${classes.footer} ${classes.footerMobile} ${
            isHideQuickKeyBar && currentTab === 1 && classes.hideQuickKeybar
          }`}
        >
          {currentTab === 0 && (
            <>
          ...
          {currentTab === 1 &&
            (!isHideQuickKeyBar ? (
              <>
                <div
                  className={`${classes.keyBoardBar} ${classes.rightBorder}`}
                >
                  <IconButton
                    aria-label='tab'
                ...
                >
                  <IconButton
                    ...
                    className={classes.button}
                  >
                    <span className={classes.span} style={{ fontSize: '30px' }}>
                      /
                    </span>
                  </IconButton>
                </div>
                ...
                >
                  {open && (
                    <>
                      <div
                        className={`${classes.moreOptions} ${classes.bottomBorder}`}
                      >
                        <MenuItem
                          onClick={(e) => {
                        ...
                        <MenuItem onClick={() => this.addQuickKey('')}>
                          <span
                      ...
                      <div className={classes.moreOptions}>
                        <MenuItem onClick={() => this.addQuickKey('equal')}>
                          <span
                            className={classes.span}
                            style={{ fontSize: '30px' }}
                          >
                        ...
                        <MenuItem onClick={() => this.addQuickKey('semiquote')}>
                          <span
                            className={classes.span}
                            style={{ fontSize: '30px' }}
                          >
                        ...
                        <MenuItem onClick={() => this.addQuickKey('block')}>
                          <span
                            className={classes.span}
                            style={{ fontSize: '25px' }}
                          >
