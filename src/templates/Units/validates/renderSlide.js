...
export const renderSlide = (slide, slideNumber, renderChecker, isCheckedOf) => {
  switch (slideNumber) {
    case 0:
      return <div id="lesson-page" style={{ height: "100%" }}>
        <ReflexElement flex={1} style={{ height: "100%" }} className={`snapshot snap1 white hide-help swiper-slide`}>
          ...
          <div class='white'>
            ...
            <div class="">
              {isCheckedOf(0, 0) ? <div class="button-locked">
    ...
    case 10: return <div id="lesson-page" style={{ height: "100%" }}>
      <ReflexElement flex={1} style={{ height: "100%" }} className={`swiper-slide checkpoint cp_yellow`}>
        ...
        <div class='container'>
          ...
          <div style={{ marginTop: '3rem' }}>
            <ol style={{ listStyle: 'none', paddingLeft: 0 }}>
              <li class='task-1'>
                <p style={{ display: 'flex', alignItems: 'center' }}>{renderChecker(10, 0)} Type your name between tags.</p>
              </li>
            </ol>
          </div>
        ...
        <div class='container'>
          {isCheckedOf(10, 0) ? <div class='button-locked'>
