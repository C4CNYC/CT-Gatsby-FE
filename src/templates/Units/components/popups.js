...
export const Aftersignup = ()=>(
    <div id="aftersignupPanel" className="bottom-arrow" style={{
        height: '330px',
        width: '630px',
        backgroundColor: '#fff',
        borderRadius: '10px',
        ...
        <h2 style={{color: 'black', fontSize: '20px', margin: '5px'}}>CONGRATS YOU HAVE SUCCESSFULLLY REGISTERED</h2>
        <span style={{color: 'black', margin: '8px'}}>Please could you add in few more details about yourself so we can stay in touch.</span>
