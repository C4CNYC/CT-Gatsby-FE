...
const signup = () => (
    ...
    <div id="signupPanel" style={{
        ...
        <div style={{ color: '#364954', cursor: 'pointer', margin: '5px', marginTop: '20px' }} onClick={goLogin}>I’ve been here before.  <span style={{ color: '#43D4DD' }}>Let me login.</span></div>
